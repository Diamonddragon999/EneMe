...
class DisplayDayCount extends StatefulWidget {
  ...
  const DisplayDayCount({super.key, 
...
class _DisplayDayCountState extends State<DisplayDayCount> {
  ...
  late Function parentUpdate; // Stores reference to a StateUpdate function in the Parent view
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: SimpleFoldingCell.create(
          ...
          borderRadius: 5, innerWidget: null,
        ),
      ),
    );
  }
...
class DayCountFormWidget extends StatefulWidget {
  ...
  const DayCountFormWidget({super.key, 
